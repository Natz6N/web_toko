...
import { BreadcrumbItem, Category, Product } from '@/types/index';
...
export default function UpdateProduct({ product, categories }: UpdateProductProps) {
    ...
    const [category, setCategory] = useState<string>(product.category_id?.toString() || '');
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        router.post(route('products.update.dashboard', { id: product.id }), formData, {
            forceFormData: true,
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                        ...
                        <Card className="p-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <div className="space-y-6">
                                    ...
                                    {/* Category */}
                                    <div className="space-y-2">
                                        <Label htmlFor="category" className={errors.category_id ? 'text-red-500' : ''}>
